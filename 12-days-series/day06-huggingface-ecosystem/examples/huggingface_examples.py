...
def example_pipeline_api():
    ...
    try:
        ...
        context = "Hugging Face is a company that focuses on natural language processing."
...
def compare_models():
    ...
    for model, info in models_comparison.items():
        print(f"{model:<15} {info['size']:<12} {info['speed']:<12} {info['accuracy']:<12} {info['use_case']}")
